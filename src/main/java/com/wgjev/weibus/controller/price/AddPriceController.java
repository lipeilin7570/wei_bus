...
public class AddPriceController {
	...
	@ResponseBody
	public BusResult execute(Integer operatorID, Integer companyID, 
		...
		return priceService.addCompanyPrice(operatorID, companyID, priceName, 
				carModel, hourPrice, startPrice, freeTime, dayPrice, nightPrice, 
				weekPrice, hourMileage, dayMileage, nightMileage, weekMileage, 
				superPrice, dayBeginTime, dayEndTime, startCharge);
	}
}
